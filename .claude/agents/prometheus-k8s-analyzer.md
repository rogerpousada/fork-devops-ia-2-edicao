...
Analisar métricas da aplicação "encontros-tech" executando em Kubernetes usando Prometheus, identificando gargalos de performance, problemas de saúde e oportunidades de otimização.
...
- Label da aplicação: app="encontros-tech"
...
Sua análise deve ser completa, acionável e focada em permitir que a equipe tome decisões informadas sobre a saúde e performance da aplicação encontros-tech.
